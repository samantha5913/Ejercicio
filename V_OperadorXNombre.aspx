<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="V_OperadorXNombre.aspx.cs" Inherits="Produccion.V_OperadorXNombre" %>
           ...
           <div class="navbar-collapse collapse navbar-inverse-collapse" style="background: #006">
               <ul class="nav navbar-nav navbar-right">
                  ...
                  <li><a href="MenuSupervisor.aspx">Regresar</a></li>  
                     ...
                     <div class="row">
            <div class="col-md-12">
               <h1>Registros del Operador por Prensista.</h1>
            </div>
          </div>   
            ...
            <!-- Formulario tiempo estimado-->
                ...
                <div class="col-lg-3">  
                   <div id="Reales-form" class="form-container" >
                      <div class="row">
                         <div class="form-title">
                           <span>Buscar por Fecha y Nombre</span>
                         </div>
                      </div>
                   ...
                   <div class="input-container">
                      <div class="row">            
                        ...
                        <asp:TextBox runat="server" ID="txtfecha1"  class="form-control" placeholder="Fecha."></asp:TextBox>  
                          ...
                          <div class="col-lg-2"> <asp:ImageButton ID="Img1" runat="server" Height="29px"
            ImageUrl="~/Imagenes/alcaline_spiral_calendar.png"  Width="34px" OnClick="Img1_Click"   />
                                   </div>
                                         <br />    
                          <div class="col-lg-12"></div>
                                                                  <br /> 
                        ...
                        <asp:TextBox runat="server" ID="txtfecha2"  class="form-control" placeholder="Fecha."></asp:TextBox>   
                                                 ...
                                                 <div class="col-lg-2"> <asp:ImageButton ID="Img2" runat="server" Height="29px"
            ImageUrl="~/Imagenes/alcaline_spiral_calendar.png"  Width="34px" OnClick="Img2_Click"/>
                                   </div>
                                 <br />    
                          <div class="col-lg-12"></div>
                                                                  <br /> 
                          ...
                          <div class="col-lg-12">      
                                                             ...
                                                             <div class="col-md-6">
                            <asp:Button ID="Button1"  class="button" runat="server" Text="Descargar" OnClick="Button1_Click" />
                        </div>
                                                         <div class="col-lg-6">
           ...
           <div class="col-lg-8">
               <div style="overflow:scroll;height:480px;width:820px;">
                              <div style="width:720px;height:550px"> 
                                  <asp:GridView ID="dgvdatos" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover table-condensed small-top-margin" DataKeyNames="IDTiempoReal" DataSourceID="SqlDataSource1"
                                      BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="720px">
                                      <Columns>
                                          <asp:BoundField DataField="IDTiempoReal" HeaderText="ID" ReadOnly="True" SortExpression="IDTiempoReal" InsertVisible="False" />
                                          ...
                                          <asp:BoundField DataField="TRVelocidad" HeaderText="Velocidad" SortExpression="TRVelocidad" />
                                  ...
                                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CCLPRODUCCIONConnectionString %>" SelectCommand="F_Real" SelectCommandType="StoredProcedure">
                                      <SelectParameters>
