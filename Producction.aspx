<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Producction.aspx.cs" Inherits="Produccion.Producction" %>
           ...
           <div class="navbar-collapse collapse navbar-inverse-collapse" style="background: #006">
               <ul class="nav navbar-nav navbar-right">
                  ...
                  <li><a href="MenuSupervisor.aspx">Regresar</a></li>  
                     ...
                     <div class="row">
            <div class="col-md-12">
               <h1>Consultar Orden de Producción.</h1>
            </div>
          </div>   
