<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="VistasXHorario.aspx.cs" Inherits="Produccion.VistasXHorario" %>
    ...
    <!-- barra de navegación responsiva -->
       <div class="container">
        <div class="navbar navbar-inverse" style="background: #006">
           ...
           <div class="col-lg-8">
               <div style="overflow:scroll;height:470px;width:800px;">
                              <div style="width:800px;height:500px"> 
                                  ...
                                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CCLPRODUCCIONConnectionString %>" SelectCommand="Time_Estimadosss" SelectCommandType="StoredProcedure">
                                      <SelectParameters>
