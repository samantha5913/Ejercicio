<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="VistasSupYNom.aspx.cs" Inherits="Produccion.VistasSupYNom" %>
    ...
    <link href="font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
       ...
       <div class="container">
        <div class="navbar navbar-inverse" style="background: #006">
           ...
           <div class="navbar-collapse collapse navbar-inverse-collapse" style="background: #006">
               <ul class="nav navbar-nav navbar-right">
                  ...
                  <li><a href="MenuSupervisor.aspx">Regresar</a></li>  
                                            ...
                                            <div class="row">
            <div class="col-md-12">
               <h1>Consultar Orden de Trabajo por Máquina.</h1>
            </div>
          </div>
                   ...
                   <div class="input-container">
                      <div class="row">      
                                   ...
                                   <div class="col-lg-9">                               
                                        ...
                                        <asp:DropDownList runat="server" ID="txtmaquina"  class="form-control" >
                            ...
                            <asp:ListItem>Dgl</asp:ListItem>
                             ...
                             <div class="col-lg-2"> 
                                 <img src="Imagenes/png/settings-1.png"; width="35"; height="35"/>
                                   </div>
                                                                  <br />                  
                        ...
                        <asp:TextBox runat="server" ID="txtfecha2"  class="form-control" placeholder="Fecha."></asp:TextBox>   
                                                 ...
                                                 <div class="col-lg-2"> 
                                                              <asp:ImageButton ID="ImageButton2" runat="server" Height="29px" ImageUrl="Imagenes/png/calendar (2).png"  Width="34px" OnClick="ImageButton2_Click" />
                                   </div>
                          <br />   
                          <div class="col-lg-12"></div> 
                          <br />
                          <div class="col-lg-12">
                              ...
                              <asp:Calendar ID="Calendar2" runat="server" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#003399" Height="200px" Width="220px" OnSelectionChanged="Calendar2_SelectionChanged" Visible="False">
                                  <DayHeaderStyle BackColor="#99CCCC" ForeColor="#336666" Height="1px" />
                                  <NextPrevStyle Font-Size="8pt" ForeColor="#CCCCFF" />
                                  <OtherMonthDayStyle ForeColor="#999999" />
                                  <SelectedDayStyle BackColor="#009999" Font-Bold="True" ForeColor="#CCFF99" />
           ...
           <div class="col-lg-8">
               <div style="overflow:scroll;height:370px;width:800px;">
                              <div style="width:800px;height:470px"> 
                                  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover table-condensed small-top-margin"  DataKeyNames="IDTiempoEstimado" DataSourceID="SqlDataSource1">
                                      <Columns>
                                  ...
                                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CCLPRODUCCIONConnectionString %>" SelectCommand="Fechas_Estimados" SelectCommandType="StoredProcedure">
                                      <SelectParameters>
                                          ...
                                          <asp:ControlParameter ControlID="txtmaquina" Name="Maquina" PropertyName="SelectedValue" Type="String" />
                                      </SelectParameters>
                                  </asp:SqlDataSource>
