<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="VistasOperador.aspx.cs" Inherits="Produccion.VistasOperador" %>
       ...
       <div class="container">
        <div class="navbar navbar-inverse" style="background: #006">
           ...
           <div class="navbar-collapse collapse navbar-inverse-collapse" style="background: #006">
            ...
            ImageUrl="~/Imagenes/alcaline_spiral_calendar.png"  Width="34px" OnClick="ImageButton1_Click1"   />
                                   </div>
                                         <br />    
            ...
            ImageUrl="~/Imagenes/alcaline_spiral_calendar.png"  Width="34px" OnClick="ImageButton2_Click1"  />
                                   </div>
                                         <br />    
                          <div class="col-lg-12"></div>
                                                                  <br /> 
                                                         <br />                  
                                                              <div class="col-lg-12">
                                                                  ...
                                                                  <asp:Calendar ID="Calendar2" runat="server" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#003399" Height="200px" Visible="False" Width="220px" OnSelectionChanged="Calendar2_SelectionChanged1" >
                                                                      <DayHeaderStyle BackColor="#99CCCC" ForeColor="#336666" Height="1px" />
                                                                      <NextPrevStyle Font-Size="8pt" ForeColor="#CCCCFF" />
                                                                      <OtherMonthDayStyle ForeColor="#999999" />
                                                                      <SelectedDayStyle BackColor="#009999" Font-Bold="True" ForeColor="#CCFF99" />
           ...
           <div class="col-lg-8">
               <div style="overflow:scroll;height:450px;width:820px;">
                              <div style="width:820px;height:500px"> 
                                  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover table-condensed small-top-margin" DataKeyNames="IDTiempoReal" DataSourceID="SqlDataSource1" 
                                     >
                                      <Columns>
                                          <asp:BoundField DataField="IDTiempoReal" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="IDTiempoReal" />
                                          <asp:BoundField DataField="TRot" HeaderText="Orden" SortExpression="TRot" />
                                          ...
                                          <asp:BoundField DataField="TRCambio" HeaderText="Cambio" SortExpression="TRCambio"/>
                                          <asp:BoundField DataField="TRTiempoEtArreglo" HeaderText="Arreglo" SortExpression="TRTiempoEtArreglo" />
                                  ...
                                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CCLPRODUCCIONConnectionString %>" SelectCommand="Fechas_Real" SelectCommandType="StoredProcedure">
                                      <SelectParameters>
